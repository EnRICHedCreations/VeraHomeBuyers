// Firebase Configuration for Vera HomeBuyers
const firebaseConfig = {
    apiKey: "AIzaSyATuX5qfi7AkW1VM4-kofRQuhCCSPANzx0",
    authDomain: "verahomebuyers.firebaseapp.com",
    projectId: "verahomebuyers",
    storageBucket: "verahomebuyers.firebasestorage.app",
    messagingSenderId: "1021669706605",
    appId: "1:1021669706605:web:5c0ecc62deea0fafc82864",
    measurementId: "G-1KPGJ2HC1R"
};
...
try {
    ...
    console.log('Firebase initialized successfully for Vera HomeBuyers');
} catch (error) {
...
// Utility Functions for Vera HomeBuyers
const VeraUtils = {
    validateEmail(email) {
        const re = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
    ...
    showMessage(message, type = 'info') {
        ...
        toast.className = `fixed top-24 right-4 z-50 px-6 py-4 rounded-lg shadow-xl transform transition-all duration-500 ${
